...
/**
 * 
 * RemittanceDataSource 
 *
 * @author Alejandro González
 * Nexis Servicios Informáticos http://www.nexis.es
 */

public class RemittanceDataSource {
	...
	/** Registro Actual */
	private int m_currentRecord = 0; // -1 porque lo primero que se hace es un ++
	
	private MRemittance remittance=null;
	
	
	
	public RemittanceDataSource (MRemittance remit)	{
		remittance = remit;
		loadData();
	}
