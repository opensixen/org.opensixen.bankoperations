...
/** Generated Model for C_BankRegulation
 *  @author opensiXen (generated) 
 *  @version Release 1.0 */
public class X_C_BankRegulation extends PO implements I_C_BankRegulation, I_Persistent 
{
    ...
    public X_C_BankRegulation (Properties ctx, int C_BankRegulation_ID, String trxName)
    {
      super (ctx, C_BankRegulation_ID, trxName);
      /** if (C_BankRegulation_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_C_BankRegulation (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_BankRegulation[")
	...
	public void setC_BankRegulation_ID (int C_BankRegulation_ID)
	{
		if (C_BankRegulation_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_C_BankRegulation_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_C_BankRegulation_ID, Integer.valueOf(C_BankRegulation_ID));
	}
